...
<div class="container-fluid">
  ...
  <div class="row justify-content-center mt-4">
    <div class="col-10 text-center">
      <h3 class="fw-bold text-black border-bottom pb-2">Approval - Manager</h3>
    </div>
  </div>
    ...
    <div class="col-10 bg-white rounded p-3">
      ...
      <div class="table-responsive">
        <table id="reviewTable" class="table table-bordered text-center align-middle w-100">
          ...
          @forelse ($reviews as $review)
            @php
              ...
              if (in_array($raw, ['verifikasi 1','verifikasi 2','verifikasi 3'])) {
                $cls='primary'; $icon='bi-activity'; $label='Progress'; $sub='Verifikasi '.explode(' ', $raw)[1];
              } elseif ($raw === 'return') {
            ...
            <tr>
              ...
              <td>
                ...
                <div class="modal fade" id="riwayatModal{{ $review->id }}" tabindex="-1" aria-labelledby="riwayatLabel{{ $review->id }}" aria-hidden="true">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="riwayatLabel{{ $review->id }}">Riwayat Komunikasi</h5>
                      ...
                      <div class="modal-body text-start">
                        ...
                        @else
                          <p class="text-muted mb-0">Tidak ada riwayat komunikasi.</p>
                        @endif
                      </div>
              ...
              <td>
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                      <a class="dropdown-item" href="{{ route('approval.manager.show', $review->id) }}">
          ...
          @empty
            <tr><td colspan="9" class="text-muted">Belum ada histori review.</td></tr>
          @endforelse
          </tbody>
        </table>
      </div>
...
<script>
  $(function() {
    const dt = $('#reviewTable').DataTable({
      dom: 'lrt',
      paging: false,
      info: false,
      ordering: true,
